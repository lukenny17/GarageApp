                            ...
                            @foreach ($services as $index => $service)
                                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                    <img src="/images/{{ strtolower(str_replace(' ', '_', $service->serviceName)) }}.jpg"
                                        class="d-block w-100 rounded-3" alt="{{ $service->serviceName }}">
    ...
    <section id="testimonials" class="py-5">
        <div class="container">
            ...
            <div id="testimonialCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    {{-- Default, admin-created testimonials loaded --}}
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8">
                                <div class="testimonial text-center">
                                    <p class="lead">"Excellent service! My car has never run better. Highly recommend Luxe
                                        Auto."</p>
                                    <p>- John Doe</p>
                                </div>
                            </div>
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8">
                                <div class="testimonial text-center">
                                    <p class="lead">"Professional and friendly staff. They fixed my car quickly and at a
                                        fair price."</p>
                                    <p>- Jane Smith</p>
                                </div>
                            </div>
                    ...
                    {{-- Only loads five star reviews from database --}}
